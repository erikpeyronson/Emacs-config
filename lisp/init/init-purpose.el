...
(use-package window-purpose
  ...
  ;;  ( (kbd "p") 'purpose-mode)
  (global-set-key (kbd "C-c l") purpose-mode-map)
  (define-prefix-command 'purpose-mode-map)
  (global-set-key (kbd "C-c l") 'purpose-load-window-layout)
  ...
  (add-to-list 'purpose-user-mode-purposes '(magit-mode . msg))
  (add-to-list 'purpose-user-regexp-purposes '("^*magit-.*-popup*$" . msg))
  (add-to-list 'purpose-user-name-purposes '("*magit-pull-popup*" . msg))
