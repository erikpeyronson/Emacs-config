...
*** text 
     #+BEGIN_SRC emacs-lisp :tangle yes
       (bind-map core-text-map
         :keys ((core-keys-make-prefix "x"))
         :evil-keys ((core-keys-make-evil-prefix "x"))
         :evil-states (normal motion visual)
         :prefix-cmd text
         :bindings
         ("TAB" 'indent-rigidly
...
*** keys
    #+BEGIN_SRC emacs-lisp :tangle yes
      (bind-map-set-keys core-base-map
        "'" 'my/main-shell
        "/" 'my/buffer-shell)
    #+END_SRC
***  registers/rings/resume
     #+BEGIN_SRC emacs-lisp :tangle yes
       (bind-map core-reg-ring-resume-map
         :keys ((core-keys-make-prefix "r"))
         :evil-keys ((core-keys-make-evil-prefix "r"))
         :evil-states (normal motion visual)
