...
*** magit
  #+BEGIN_SRC emacs-lisp :tangle yes
    (use-package magit
      ...
      :config
      (add-to-list 'display-buffer-alist
		   '("magit: " (display-buffer-pop-up-frame))))
  #+END_SRC
*** evil-magit
     #+BEGIN_SRC emacs-lisp :tangle yes
...
**** funcs
	 ...
	 (subword-mode))
       ;;  stop emacs from consantly opening new windows
       (add-to-list 'display-buffer-alist
		    '(".*.h" (display-buffer-same-window )))
       (add-to-list 'display-buffer-alist
		    '(".*.cpp" (display-buffer-same-window )))
       (add-to-list 'display-buffer-alist
		    '(".*.hpp" (display-buffer-same-window )))
       (add-to-list 'display-buffer-alist
		    '(".*.cc" (display-buffer-same-window )))
     #+END_SRC
